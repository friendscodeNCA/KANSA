...
export class EditarPerfilPage implements OnInit {
  ...
  async guardarDataUsuario() {
    let inputElement = document.getElementById("datetime") as HTMLInputElement;
    let valorFechaNacimiento = inputElement.value;
    console.log('prueba', valorFechaNacimiento, this.usuarioForm.value);
    this.usuarioForm.controls['direccion'].setValue(this.userUbicacion);
    this.usuarioForm.controls['fechaNacimiento'].setValue(valorFechaNacimiento);
